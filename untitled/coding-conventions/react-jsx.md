...
1. [Basic Rules](react-jsx.md#basic-rules)
2. [Class vs `React.createClass` vs stateless](react-jsx.md#class-vs-reactcreateclass-vs-stateless)
3. [Mixins](react-jsx.md#mixins)
4. [Naming](react-jsx.md#naming)
5. [Declaration](react-jsx.md#declaration)
6. [Alignment](react-jsx.md#alignment)
7. [Quotes](react-jsx.md#quotes)
8. [Spacing](react-jsx.md#spacing)
9. [Props](react-jsx.md#props)
10. [Refs](react-jsx.md#refs)
11. [Parentheses](react-jsx.md#parentheses)
12. [Tags](react-jsx.md#tags)
13. [Methods](react-jsx.md#methods)
14. [Ordering](react-jsx.md#ordering)
15. [`isMounted`](react-jsx.md#ismounted)
...
* _getter methods for_ `render` like `getSelectReason()` or `getFooterContent()`
...
[**⬆ back to top**](react-jsx.md#table-of-contents)
